export const personalInfo = {
  ...
  email: "nithishkumarseeni@gmail.com",
...
export const projects = [
  {
    ...
    description:
      "Created a Student Portal demo for Career Lines to manage and showcase student activities.",
    category: "Student Activities / Career Lines",
    year: "2026",
    tech: ["React", "Web Development"],
    github: "https://github.com/S-NithishKumar-07/student-portal",
  },
  {
    id: 2,
    title: "Cryptocurrency Price Prediction",
    description:
      "A final year machine learning project developed to predict cryptocurrency price values using the LSTM (Long Short-Term Memory) algorithm.",
    category: "Final Year Project / Machine Learning",
    year: "2026",
    tech: ["Python", "LSTM", "Machine Learning"],
    github: "https://github.com/S-NithishKumar-07/CryptoPrice",
  },
  {
    id: 3,
    title: "Portfolio Websites",
    description:
      "Successfully designed and delivered 2 portfolio websites for clients.",
    category: "Freelance / Web Development",
    tech: ["Web Development"],
    displayLabel: "02 Portfolios Delivered",
    portfolioLinks: [
      {
        label: "Portfolio 01",
        url: "https://shanmuga-priyan-portfolio-ashen.vercel.app/",
      },
      {
        label: "Portfolio 02",
        url: "https://nitz-portfolio.vercel.app/",
      },
    ],
  },
  {
    ...
    description:
      "Created a property selling platform while working at Achiever IT Training.",
    category: "Web Development",
    tech: ["Web Development"],
    company: "Achiever IT Training",
  },
  {
    id: 5,
    title: "Expense App",
    description:
      "Developed an expense management application for PSN Traders.",
    category: "Mobile Application",
    tech: ["Flutter", "React Native", "Dart"],
    company: "PSN Traders",
    github: "https://github.com/S-NithishKumar-07/Expense-App",
  },
];
...
export const education = [
  ...
  },
  {
    ...
    institution: "DKG Model Higher Secondary School",
    year: "2020 – 2022",
    grade: "",
  },
  {
